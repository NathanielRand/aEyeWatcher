...
<div class="page">
  ...
  {#if !store.scanResult}
    <div class="empty"><span class="ei">⟷</span><p>Run a scan to detect Protocol Gateways.</p><a href="/scan" class="scan-link">◉ Scan Center</a></div>
  {:else if items.length === 0}
    <div class="empty-inner">No gateways detected. LiteLLM, Portkey, OpenClaw Gateway, and Hermes Gateway are probed automatically.</div>
  {:else}
    <div class="item-list">
      {#each items as item}
        <div class="item-row">
