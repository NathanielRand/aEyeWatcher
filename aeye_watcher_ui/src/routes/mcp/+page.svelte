...
<div class="page">
  ...
  {#if !store.scanResult}
    <div class="empty"><span class="ei">⬡</span><p>Run a scan to detect MCP Servers.</p><a href="/scan" class="scan-link">◉ Scan Center</a></div>
  {:else if items.length === 0}
    <div class="empty-inner">No MCP server configurations found. Add servers to your Claude Desktop, Cursor, or Continue config.</div>
  {:else}
    <div class="item-list">
      {#each items as item}
        <div class="item-row">
